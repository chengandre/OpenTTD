...
const SaveLoadCompat _settings_sl_compat[] = {
	...
	SLC_VAR("vehicle.max_truck_type_isenabled"),
	SLC_VAR("vehicle.max_roadveh_trucks"),
	SLC_VAR("vehicle.max_bus_type_isenabled"),
	SLC_VAR("vehicle.max_roadveh_buses"),
	SLC_VAR("vehicle.max_aircraft"),
	SLC_VAR("vehicle.max_max_airplane_type_isenabled"),
	SLC_VAR("vehicle.max_airplanes"),
	SLC_VAR("vehicle.max_helicopter_type_isenabled"),
	SLC_VAR("vehicle.max_helicopters"),
